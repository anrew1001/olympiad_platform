...
- **Дополнительно** -- Геймификация: система достижений (очки и награды за решение задач и победы в матчах). Досрочная победа — если разница в счёте достигает 2 очков, матч завершается автоматически. Кнопка «Сдаться» — игрок может завершить матч досрочно, засчитывается поражение. Статистика платформы — общее количество задач, пользователей и проведённых матчей на главной странице.
